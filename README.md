...
As these m920q systems are getting old, mine has a build date of 20/06, it is sensible to replace the original coin cell BIOS battery.
...
When purchasing used you may run into password locked BIOS' and other configuration oddities. I prefer to reset as much as I can to factory settings first, and then apply my settings from there.
...
* Connect the PCI riser board to the I350-T4 PCI card on the workbench (not in the chassis).
    ...
    - The OEM WiFi card is not compatible with OPNsense and removing it or disabling it in the BIOS can save you around a watt at idle.
...
As I write this, the latest released BIOS for the m920q is M1UKT77A/1.0.0.119. As well as various security patches (three CVE's in the prior, 75A build), I noted large reductions in boot times by upgrading my system and recommend it.
...
If you are interested in utilizing the hardware more, there are [many][20] [great][21] [discussion][22] online about the pros and cons of OPNsense in a VM on a m920q.
...
The benefit to the m920q over the m720q is the remote access & management available when connecting via the onboard NIC.  Intel initially provided [MeshCommander][24] for windows but has since deprecated it and now supports the open source [MeshCentral][19] web based tool ([GitHub link][23]).
...
I recommend running [Prime95][13] and [memtest86][14] to stress test the CPU, active cooling, and memory systems before installing and configuring as a router.

Memtest86 will take around 90 minutes with 8G of Ram installed and I run Prime95 for around an hour to make sure the system gets thermally saturated.
...
[19]: https://meshcentral.com/
[20]: https://www.reddit.com/r/Proxmox/comments/15sk3ox/lenovo_m920q_tiny_for_proxmox/
[21]: https://www.reddit.com/r/opnsense/comments/1ejukmz/install_opnsense_standalone_or_on_proxmox/
[22]: https://forums.servethehome.com/index.php?threads/tinyminimicro-firewall-edition.36039/
[23]: https://github.com/Ylianst/MeshCentral
[24]: https://www.meshcommander.com/
